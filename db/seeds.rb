...
# usuarios solo para reviews
usuario4 = User.new(email: "usuario4@usuario.com", password: "123456")
usuario4.save!

usuario5 = User.new(email: "usuario5@usuario.com", password: "123456")
usuario5.save!

usuario6 = User.new(email: "usuario6@usuario.com", password: "123456")
usuario6.save!

usuario7 = User.new(email: "usuario7@usuario.com", password: "123456")
usuario7.save!
...
usuario.avatar.attach(io: file_1, filename: "usuario_1.jpg", content_type: "image/jpg")
usuario.save!
...
usuario1.avatar.attach(io: file_1, filename: "usuario_1.jpg", content_type: "image/jpg")
usuario1.save!
...
usuario2.avatar.attach(io: file_1, filename: "usuario_1.jpg", content_type: "image/jpg")
usuario2.save!
...
usuario3.avatar.attach(io: file_1, filename: "usuario_1.jpg", content_type: "image/jpg")
usuario3.save!

# usuarios reviews

file_1 = URI.open("https://images.unsplash.com/photo-1479936343636-73cdc5aae0c3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80")

usuario4.avatar.attach(io: file_1, filename: "usuario_4.jpg", content_type: "image/jpg")
usuario4.save!

file_1 = URI.open("https://images.unsplash.com/photo-1597223557154-721c1cecc4b0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80")

usuario5.avatar.attach(io: file_1, filename: "usuario_5.jpg", content_type: "image/jpg")
usuario5.save!

file_1 = URI.open("https://images.unsplash.com/photo-1595152772835-219674b2a8a6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80")

usuario6.avatar.attach(io: file_1, filename: "usuario_6.jpg", content_type: "image/jpg")
usuario6.save!

file_1 = URI.open("https://images.unsplash.com/photo-1546820389-44d77e1f3b31?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=464&q=80")

usuario7.avatar.attach(io: file_1, filename: "usuario_7.jpg", content_type: "image/jpg")
usuario7.save!

# creando rutas
route0 = Route.new(name: "Casco Histórico de Caracas", description: "Una caminata al pasado, casa del Libertador Simón Bolívar, Plaza Bolívar, La Casa Amarilla, estilo arquitectónico colonial y neoclásico en una ruta que te traslada a grandes momentos históricos pre y post independentistas.", duration: 4, places_interest: "Cafetería Páramo, Restaurante el Techo de la Ballena, Cocadas, Heladería", available_dates: "20211129,20211130", price: 20, user_id: guide.id)
route0.save!

route1 = Route.new(name: "Ruta de los Museos - Caracas", description: "Ruta por el Arte Contemporáneo, Arte Nacional y Artes plásticas que se combinan con estructuras arquitectónicas neoclásicas de más de 100 años y estructuras con diseño brutalista, una combinación única.", duration: 4, places_interest: "Puesto de raspados, Panaderías, Restaurantes.", available_dates: "20211130,20211201", price: 15, user_id: guide1.id)
route1.save!

route2 = Route.new(name: "Arquitectura con estilo", description: "Una ruta llena de estructuras arquitectónicas de distintos estilos, neogótico, neoclásico y neobarroco, que se encuentran muy cerca unos de otros y que, además, tienen una historia que contar.", duration: 2, places_interest: "Cafetería, Centro Comercial", available_dates: "20211204,20211205", price: 10, user_id: guide2.id)
route2.save!

route3 = Route.new(name: "Rascacielos en Caracas", description: "Toda gran ciudad tiene rascacielos, Caracas no se queda atrás, las Torres de Parque Central son los segundos rascacielos más altos de Sudamérica.", duration: 5, places_interest: "Panadería, Restaurante", available_dates: "20211204,20211205", price: 8, user_id: guide1.id)
route3.save!

route4 = Route.new(name: "Los 7 Templos", description: "Tradiciones de Semana Santa que son joyas arquitectónicas que guarda la ciudad, estilo neoclásico y neogótico, historias y leyendas que se unen.", duration: 4, places_interest: "Souvenirs, Puestos de comida rápida", available_dates: "20211206,20211207", price: 10, user_id: guide3.id)
route4.save!

route5 = Route.new(name: "Las esquinas de Caracas", description: "Una característica particular de la ciudad; la torre, la principal, las monjas, la sociedad; descubre el porqué de estos curiosos nombres.", duration: 6, places_interest: "Cafe Bolívar, Restaurante, Cocada", available_dates: "20211213,20211214", price: 20, user_id: guide.id)
route5.save!
...
place1 = Place.new(name: "Plaza Bolívar", description: "  En ella se encuentra la Estatua ecuestre de Simón Bolívar, obra del escultor italiano Adamo Tadolini.", address: "Centro, Esquina La Torre, Caracas", route_id: route0.id, latitude: 10.5048301, longitude: -66.9141038)
place1.save!
...
#para la ruta 1
place4 = Place.new(name: "Museo de Bellas Artes", description: "  Su fundación data de 1918. Las dos estructuras que albergan al museo fueron diseñadas por el arquitecto Carlos Raúl Villanueva.", address: "Centro, Plaza de los Museos, Bellas Artes, Caracas 1050", route_id: route1.id, latitude: 10.5006126, longitude: -66.8991782)
place4.save!

#para la ruta 2
place5 = Place.new(name: "Palacio de las Academias", description: "  Edificación Colonial con estilo neogótico de Caracas, Venezuela. Ubicada en la Avenida Universidad.", address: "Centro, Esquina La Bolsa, Caracas", route_id: route2.id, latitude: 10.5046717, longitude: -66.9168704)
place5.save!
...
# creo bookings
# para la ruta 0
# booking1 = Booking.new(user_id:usuario.id, check_in: '2021-11-29', route_id:route0.id , pago_user: rand(25987539..99999999))
# booking1.save!

booking2 = Booking.new(user_id: usuario1.id, check_in: "2021-11-29", route_id: route0.id, pago_user: rand(25987539..99999999))
booking2.save!

booking3 = Booking.new(user_id: usuario2.id, check_in: "2021-11-29", route_id: route0.id, pago_user: rand(25987539..99999999))
booking3.save!

booking4 = Booking.new(user_id: usuario3.id, check_in: "2021-11-29", route_id: route0.id)
booking4.save!

# para la ruta 1
booking5 = Booking.new(user_id: usuario1.id, check_in: "2021-12-01", route_id: route1.id, pago_user: rand(25987539..99999999))
booking5.save!

booking6 = Booking.new(user_id: usuario2.id, check_in: "2021-11-30", route_id: route1.id)
booking6.save!

# para la ruta 2
booking7 = Booking.new(user_id: usuario.id, check_in: "2021-12-04", route_id: route2.id, pago_user: rand(25987539..99999999), status_pago: true)
booking7.save!

booking8 = Booking.new(user_id: usuario3.id, check_in: "2021-12-05", route_id: route2.id)
booking8.save!

# para la ruta 3
booking9 = Booking.new(user_id: usuario1.id, check_in: "2021-12-04", route_id: route3.id)
booking9.id
booking9.save!

booking10 = Booking.new(user_id: usuario2.id, check_in: "2021-12-05", route_id: route3.id, pago_user: rand(25987539..99999999))
booking10.save!

# para la ruta 4
booking11 = Booking.new(user_id: usuario2.id, check_in: "2021-12-06", route_id: route4.id)
booking11.save!

booking12 = Booking.new(user_id: usuario3.id, check_in: "2021-12-06", route_id: route5.id, pago_user: rand(25987539..99999999), status_pago: true)
booking12.save!

# para la ruta 5
booking11 = Booking.new(user_id: usuario2.id, check_in: "2021-12-14", route_id: route5.id, pago_user: rand(25987539..99999999))
booking11.save!

booking13 = Booking.new(user_id: usuario3.id, check_in: "2021-12-14", route_id: route5.id, pago_user: rand(25987539..99999999), status_pago: true)
booking13.save!

booking13 = Booking.new(user_id: usuario.id, check_in: "2021-12-14", route_id: route5.id)
booking13.save!

# creo reviews

#usuarios
usr = [usuario1.id, usuario2.id, usuario3.id, usuario4.id, usuario5.id, usuario6.id, usuario7.id]
